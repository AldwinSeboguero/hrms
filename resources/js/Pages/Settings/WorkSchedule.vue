...
const openUpdateModal = (formData) => {
    form.id = formData.id;
    form.name = formData.data.Description;
    form.TimeDesc = formData.data.TimeDesc;
    form.Type = formData.data.Type;
    form.Days = formData.data.Days;
...
const sortedDays = (days) => {
    ...
    return order.filter(day => days.hasOwnProperty(day)); // Check if the day exists in the days object
};
...
<template>
    ...
    <div class="px-4 pb-4 w-full">
        <el-dialog v-model="dialogVisible" title="Tips" :show-close="false" class="rounded-lg max-screen-xs">
                ...
                <div class="my-header">
                    <div class="flex items-center justify-between p-2 md:p-3 border-b rounded-t dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            {{ form.id ? "Edit" : "Add" }} Work Schedule
                        </h3>
            ...
            <div class="relative px-4 pb-4 w-full max-w-full max-h-full overflow-auto" style="max-height: 80vh;">
                <form @submit.prevent="submit">
                    <div class="grid gap-4 mb-4 grid-cols-6">
                        ...
                        <div class="col-span-4">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Time
                                Description</label>
                            <input v-model="form.TimeDesc" required type="text" name="name" id="name"
                                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        </div>
                        <div class="col-span-6 sm:col-span-2">
                            <label for="category"
                                ...
                                Type</label>
                            <select v-model="form.Type" required id="country" name="country" autocomplete="country-name"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                <option></option>
                                <option value="Fixed" key="Fixed">Fixed</option>
                            </select>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <table class="divide-gray-200 w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="day in sortedDays(form.Days)" :key="day">
                                        <td class="px-6 py-4 whitespace-nowrap">{{ day }} </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <input type="checkbox" :name="day" v-model="form.Days[day].enabled"
                                                class="form-checkbox">
                                        </td>
                                        ...
                                        <td class="px-1 py-4  ">
                                            <div class="relative">
                                                ...
                                                <input type="time" :name="day + '_time_in_am'"
                                                    v-model="form.Days[day].timeInAM" 
                                        ...
                                        <td class="px-1 py-4 whitespace-nowrap">
                                            <div class="relative">
                                                ...
                                                <input type="time" :name="day + '_time_out_am'"
                                                v-model="form.Days[day].timeOutAM" 
                                                :disabled="!form.Days[day].enabled"
                                                    class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
                                                    required />
                                            </div> 
                                        ...
                                        <td class="px-1 py-4 whitespace-nowrap">
                                            <div class="relative">
                                                ...
                                                <input type="time" :name="day + '_time_in_pm'"
                                                v-model="form.Days[day].timeInPM" 
                                                :disabled="!form.Days[day].enabled"
                                                    class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
                                                    required />
                                            </div> 
                                        ...
                                        <td class="px-1 py-4 whitespace-nowrap">
                                            <div class="relative">
                                                ...
                                                <input type="time" :name="day + '_time_out_pm'"
                                                v-model="form.Days[day].timeOutPM"  
                                                :disabled="!form.Days[day].enabled"
                                                    class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
                                                    required />
                                            </div> 
                                        ...
                                        <tr>
                                            <div class="flex  max-w-sm">
                                                ...
                                                <div class="relative w-full">
                                                    ...
                                                    <input @change="searchName(search)" v-model="search" type="text"
                                                        id="simple-search"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                        placeholder="Search Work Schedule..." required />
                                                </div>
                                        ...
                                        <div class="flex flex-col items-left mt-4">
                                            <span class="text-sm text-gray-700 dark:text-gray-400">
                                                Showing <span class="font-semibold text-gray-900 dark:text-white">{{
                                                    pagination.from }}</span> to <span
                                                    class="font-semibold text-gray-900 dark:text-white">{{ pagination.to
                                                    }}</span>
                                                of
                                            ...
                                            <div class="inline-flex mt-2 xs:mt-0">
                                                ...
                                                <button v-if="(pagination.current_page - 1) >= 1"
                                                    @click="getWorkDays(pagination.current_page - 1, search)"
