                            ...
                            <form class=" " @submit.prevent="submit">
                                <div class="grid gap-4 mb-4 grid-cols-4">
                                    <div class="col-span-4 sm:col-span-2">
                                        <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Renewable Type</label>
                                    ...
                                    <div class="col-span-4 sm:col-span-2">
                                        <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date Issued</label>
                                ...
                                />  </div>
                                    <div class="col-span-4 sm:col-span-2">
                                        ...
                                        <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Renewal Date</label>
