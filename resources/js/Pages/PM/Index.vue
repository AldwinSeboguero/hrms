...
const totalIPCROutstanding = ref('0');
const totalIPCRVerySatisfactory = ref('0');
const totalIPCRSatisfactory = ref('0');
const totalIPCRUnsatisfactory = ref('0');
const totalIPCRPoor = ref('0');

const totalOPCROutstanding = ref('0');
const totalOPCRVerySatisfactory = ref('0');
const totalOPCRSatisfactory = ref('0');
const totalOPCRUnsatisfactory = ref('0');
const totalOPCRPoor = ref('0');
const getLeaveStat = async () => {
        ...
        try {
            ...
            totalIPCROutstanding.value = response.data.totalIPCROutstanding;
            totalIPCRVerySatisfactory.value = response.data.totalIPCRVerySatisfactory;
            totalIPCRSatisfactory.value = response.data.totalIPCRSatisfactory;
            totalIPCRUnsatisfactory.value = response.data.totalIPCRUnsatisfactory;
            totalIPCRPoor.value = response.data.totalIPCRPoor;

          totalOPCROutstanding.value = response.data.totalOPCROutstanding;
            totalOPCRVerySatisfactory.value = response.data.totalOPCRVerySatisfactory;
            totalOPCRSatisfactory.value = response.data.totalOPCRSatisfactory;
            totalOPCRUnsatisfactory.value = response.data.totalOPCRUnsatisfactory;
            totalOPCRPoor.value = response.data.totalOPCRPoor;
            ...
            <div class="col-span-12 sm:col-span-6 md:col-span-2">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        ...
                        <div class="font-bold text-lg">{{ totalIPCROutstanding }}</div>
                    </div>
                </div>
            </div>
            <div class="col-span-12 sm:col-span-6 md:col-span-2">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        ...
                        <div class="font-bold text-lg">{{ totalIPCRVerySatisfactory }}</div>
                    </div>
                </div>
            </div>
            <div class="col-span-12 sm:col-span-6 md:col-span-2">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        ...
                        <div class="font-bold text-lg">{{ totalIPCRSatisfactory }}</div>
                    </div>
                </div>
            </div>
            <div class="col-span-12 sm:col-span-6 md:col-span-2">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        ...
                        <div class="font-bold text-lg">{{ totalIPCRUnsatisfactory }}</div>
                    </div>
                </div>
            </div>
             <div class="col-span-12 sm:col-span-6 md:col-span-2">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        ...
                        <div class="font-bold text-lg">{{ totalIPCRPoor }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-12 sm:col-span-6 md:col-span-2">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        <div class="text-sm text-gray-500">Outstanding</div>
                        <div class="font-bold text-lg">{{ totalOPCROutstanding }}</div>
                    </div>
                </div>
            </div>
            <div class="col-span-12 sm:col-span-6 md:col-span-2">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        <div class="text-xs text-gray-500">Very Satisfactory</div>
                        <div class="font-bold text-lg">{{ totalOPCRVerySatisfactory }}</div>
                    </div>
                </div>
            </div>
            <div class="col-span-12 sm:col-span-6 md:col-span-2">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        <div class="text-xs text-gray-500">Satisfactory </div>
                        <div class="font-bold text-lg">{{ totalOPCRSatisfactory }}</div>
                    </div>
                </div>
            </div>
            <div class="col-span-12 sm:col-span-6 md:col-span-2">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        <div class="text-xs text-gray-500">UnSatisfactory</div>
                        <div class="font-bold text-lg">{{ totalOPCRUnsatisfactory }}</div>
                    </div>
                </div>
            </div>
             <div class="col-span-12 sm:col-span-6 md:col-span-2">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        <div class="text-xs text-gray-500">Poor</div>
                        <div class="font-bold text-lg">{{ totalOPCRPoor }}</div>
                    </div>
                </div>
            </div>
        </div>
