...
watch(search,debounce(async function (value) {
          ...
          <form class="max-w-full mx-auto">
            ...
            <div class=" rounded-lg shadow-md  mt-2">
                ...
                <div class="relative flex-1 md:flex-none w-full  mb-4">
                    <input type="text" v-model="search" id="search" class="block p-2 text-sm text-gray-900 border border-gray-300 rounded-lg w-full bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500" placeholder="Search...">
