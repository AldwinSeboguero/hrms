...
console.log(url)
  ...
  const url = route('generate-attendancewithscanned', { event_id : event_date_id.value})
  window.location.href = url  
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg ">
              ...
              <div
                ...
                <div class="col-span-1">
                  <form class="max-w-full mx-auto mb-4 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 ">
                      ...
                      <!-- component --> 
                      <a v-if="event_date_id" @click="generatePdfWithScanned" href="#" class="text-white w-full font-semibold text-xs pr-4 my-auto mx-auto bg-gradient-to-r from-red-800 to-red-500 p-4 py-2 px-5 rounded-md">
              ...
              <table class="w-full text-sm text-left rtl:text-right text-gray-600 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase dark:text-gray-400">
                  ...
                  <tbody>
                    <tr class="border-b border-gray-200 dark:border-gray-700" v-for="(participant, index) in participants"
                      :key="participant.id" :value="participant.id">
                      <th scope="row"
