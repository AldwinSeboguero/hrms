      ...
      <aside id="logo-sidebar"
        ...
        <div class="m-1 rounded-full fill-cyan-500 drop-shadow-lg ">
          <div class="bg-white rounded-lg mb-4">
            ...
            <div class="h-screen px-3 pb-4 pt-4 overflow-y-auto dark:bg-gray-800 ">
              <div
                class="px-6 pt-2 max-w-sm mx-auto text-white bg-gradient-to-r from-indigo-950 via-blue-800 to-blue-800  shadow-lg  items-center space-x-4 pb-3 rounded-lg">
             ...
             <svg class="h-10 w-10  text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div>
                  <div class="text-md font-medium text-white font-black text-balance">{{ $page.props.auth.user.name }}
                  </div>
              ...
              <ul class="space-y-2 font-medium">
                <li>
                  <a :href="route('dashboard')" :active="route().current('dashboard')"
                    class=" inline-flex items-center px-4 py-3   text-md font-black font-sans rounded-lg active w-full dark:bg-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    :class="{ 'bg-blue-50 text-blue-950': route().current('dashboard') }" aria-current="page">

                    <svg class="w-4 h-4 me-2 text-blue-900 active:text-red-500" xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                  <a :href="route('employees.index')" :active="route().current('employees.index')"
                    ...
                    :class="{ 'bg-blue-50 text-blue-950': route().current('employees.index') }" aria-current="page">
                ...
                <li>
                  <a :href="route('timesheets.index')" :active="route().current('timesheets.index')"
                    class="inline-flex items-center px-4 py-3  text-gray-800  text-md font-black font-sans rounded-lg active w-full dark:bg-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    :class="{ 'bg-blue-50 text-blue-950': route().current('timesheets.index') }" aria-current="page">
              ...
              <a :href="route('timesheets.index')"  :active="route().current('timesheets.index')"  class="hidden inline-flex items-center px-4 py-3  text-gray-800  text-md font-black font-sans rounded-lg active w-full dark:bg-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 group"  :class="{ 'bg-blue-50 text-blue-950':  route().current('timesheets.index') }" aria-current="page">
                ...
                <li>
                  ...
                  <ul id="dropdown-example" class="py-2 space-y-2"
                    :class="{ 'hidden': !route().current('leave.request') }">
                    <li>
                      <a href="#"
                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Summary</a>
                    </li>
                    <li>
                      <a :href="route('leave.request')" :active="route().current('leave.request')"
                    ...
                    <li>
                      <a href="#"
                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Disapproved
                        Requests
                    ...
                    <li>
                      <a href="#"
                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Leave
                        Cards</a>
                    </li>
                  </ul>
                </li>
                <li>
                  <a href="#"
                    class="inline-flex items-center px-4 py-3  text-gray-800  text-md font-black font-sans rounded-lg active w-full dark:bg-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    :class="{ 'bg-blue-50 text-blue-950': route().current('approvedrequests') }" aria-current="page">
                ...
                <li>
                  <a :href="route('performance.index')" :active="route().current('performance.index')"
                    class="inline-flex items-center px-4 py-3  text-gray-800  text-md font-black font-sans rounded-lg active w-full dark:bg-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    :class="{ 'bg-blue-50 text-blue-950': route().current('performance.index') }" aria-current="page">
                ...
                <li>
                  <a href="#"
                    class="inline-flex items-center px-4 py-3  text-gray-800  text-md font-black font-sans rounded-lg active w-full dark:bg-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    :class="{ 'bg-blue-50 text-blue-950': route().current('deficiencies') }" aria-current="page">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                      stroke="currentColor" class="w-4 h-4 me-2  text-gray-800">
                      <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                  <a href="#"
                    class="inline-flex items-center px-4 py-3  text-gray-800  text-md font-black font-sans rounded-lg active w-full dark:bg-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    :class="{ 'bg-blue-50 text-blue-950': route().current('users') }" aria-current="page">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                      stroke="currentColor" class="w-4 h-4 me-2  text-gray-800">
                      <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                  <a href="#"
                    class="inline-flex items-center px-4 py-3  text-gray-800  text-md font-black font-sans rounded-lg active w-full dark:bg-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    :class="{ 'bg-blue-50 text-blue-950': route().current('settings') }" aria-current="page">
                    <svg id="Layer_1" data-name="Layer 1" stroke-width="1.5" stroke="currentColor"
                      class="w-6 h-6 me-2  text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 80.26">
                      <defs></defs>
                      <title>hiring</title>
                      <path class="cls-1"
                ...
                <li>
                  ...
                  <ul id="dropdown-event" class="py-2 space-y-2"
                    :class="{ 'hidden': !route().current('event.list') && !route().current('event.scanner') && !route().current('event.attendance') }">

                    <li>
                      <a :href="route('event.list')" :active="route().current('event.list')"
                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 "
                    ...
                    <li>
                      <a :href="route('event.attendance')" :active="route().current('event.attendance')"
                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 "
                    ...
                    <li>
                      <a :href="route('event.scanner')" :active="route().current('event.scanner')"
                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 "
                ...
                <li>
                  <a :href="route('settings.index')" :active="route().current('settings.index')"
                    class="inline-flex items-center px-4 py-3  text-gray-800  text-md font-black font-sans rounded-lg active w-full dark:bg-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    :class="{ 'bg-blue-50 text-blue-950': route().current('settings') }" aria-current="page">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                  ...
                  <a href="https://hrms.parsu.edu.ph" class=" flex items-center space-x-4">
                    ...
                    <div>
                      <div class="text-sm md:text-xl text-blue-950 font-black font-sans uppercase">Partido State
                        University</div>
